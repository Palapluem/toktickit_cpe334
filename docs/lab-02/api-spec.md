...
`VALIDATION_FAILED`, `REQUESTER_CONTEXT_REQUIRED`, `REQUESTER_NOT_FOUND`, `REQUESTER_INACTIVE`, `TICKET_NOT_FOUND`, `ATTACHMENT_NOT_FOUND`, `ATTACHMENT_LIMIT_REACHED`, `ATTACHMENT_REMOVED`, `FILE_TOO_LARGE`, `UNSUPPORTED_FILE_TYPE`, `INTERNAL_ERROR`
...
**Failures:** `400 VALIDATION_FAILED` (any field rule, or an unknown/server-controlled property supplied) · `400 REQUESTER_CONTEXT_REQUIRED` · `400 REQUESTER_NOT_FOUND` · `400 REQUESTER_INACTIVE` · `413 FILE_TOO_LARGE` · `415 UNSUPPORTED_FILE_TYPE` · `500 INTERNAL_ERROR`
